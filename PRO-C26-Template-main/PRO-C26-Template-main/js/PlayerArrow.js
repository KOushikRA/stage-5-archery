class PlayerArrow {
  ...
  /* remove(index) {
    this.isRemoved = false;  //this is wrong because the isRemove must be true
  ...
  /* remove(index) {
    this.isRemoved = true;
    Matter.World.remove(this.body); //this has to be "World, this.body"
    delete playerArrows[index];
  } */
  ...
  /* remove(index) {
    this.isRemoved = true;
    Matter.World.remove(world, this.body);
    delete playerArrows[];  //this has to say "index" in the box brackets 
  } */
