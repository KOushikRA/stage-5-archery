  ...
  for (var i = 0; i < playerArrows.length; i++) {
    if (playerArrows[i] !== undefined) {
      playerArrows[i].display();
       ...
       var board1Collision = Matter.SAT.collides(  //this code collides the arrow with the board
        board1.body,
        playerArrows[i].body
      ); 

      /* var board1Collision = collides(     //this one and others are wrong because it has to be Matter.SAT.collides
        board1.body,
        playerArrows[i].body
      ); */
